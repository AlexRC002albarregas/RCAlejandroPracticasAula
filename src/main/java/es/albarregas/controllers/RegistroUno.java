...
public class RegistroUno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("enviar") == null && request.getParameter("volver") == null) {
            cuerpoVacio(out, request, response);
        } else if (request.getParameter("enviar") != null && request.getParameter("volver") == null) {
            ...
            if (!hayError) { // Última pantalla con los datos correctos
                ...
                out.println("<form action=\"RegistroUno\" method=\"post\" />");
                while (parametros.hasMoreElements()) {
                    String nombre = parametros.nextElement();
    ...
    private void cuerpoVacio(PrintWriter out, HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        ...
        out.println("<td colspan=\"2\"><input type=\"text\" name=\"nombre\" id=\"nb\" /></td>");
        out.println("</tr>");
        out.println("<tr>");

        out.println("<td><label for=\"ap\">Apellidos:</label></td>");
        out.println("<td colspan=\"2\"><input type=\"text\" name=\"apellidos\" id=\"ap\" /></td>");
        out.println("</tr>");
        out.println("<tr>");
        ...
        for (int i = 1; i < 32; i++) {
            String valor = (i == 1) ? "selected=\"selected\"" : "";
        ...
        for (int i = 1970; i < 2020; i++) {
            String valor = (i == 1970) ? "selected=\"selected\"" : "";
            out.println("<option value=\"" + i + "\"" + valor + ">" + i + "</option>");
        }
        out.println("</select>");
        out.println("</td>");
        ...
        out.println("<td colspan=\"2\"><input type=\"text\" name=\"usuario\" id=\"usu\" /></td>");
        out.println("</tr>");
        out.println("<tr>");

        out.println("<td><label for=\"pass\">* Contraseña:</label></td>");
        out.println("<td colspan=\"2\"><input type=\"password\" name=\"password\" id=\"pass\" /></td>");
        out.println("</tr>");
        out.println("</table>");
        out.println("</fieldset>");
        out.println("<p>&nbsp;</p>");
        ...
        out.println("<td><input type=\"button\" name=\"limpiar\" value=\"Limpiar\" onClick=\"location.href='" + request.getContextPath() + "/RegistroUno';\"/></td>");
        out.println("</tr>");
        out.println("</table>");
        out.println("</form>");
        out.println("</div>");
